  ...
  <d-navbar-nav class="border-left flex-row">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle text-nowrap px-3" v-d-toggle.user-actions>
        <img class="user-avatar rounded-circle mr-2" src="https://www.xing.com/assets/frontend_minified/img/users/nobody_f.256x256.jpg" alt="User Avatar"> <span class="d-none d-md-inline-block">usuario-dev</span>
      </a>
